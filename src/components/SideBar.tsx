...
export default function SidebarDemo() {
  ...
  return (
    <div className="flex bg-black w-[10rem]">
      <div
        className={` flex flex-col h-screen p-3 bg-black shadow duration-300`}
      >
            ...
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              ...
              <li className="rounded-sm">
                ...
                >
                  ...
                  <span className="text-gray-100">Testimonial</span>
                </Link>
              </li>
              <li className="rounded-sm">
                <Link
              ...
              <li className="rounded-sm">
                ...
                >
                  ...
                  <span className="text-gray-100">People</span>
                </Link>
              </li>
            </ul>
          </div>
